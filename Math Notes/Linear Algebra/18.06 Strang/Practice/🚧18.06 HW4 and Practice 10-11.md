---
aliases: 
date updated: Thursday, June 9th 2022, 3:18 pm
...
Recall that the special solutions can be written as $\begin{bmatrix} -F & I \end{bmatrix}'$. The dimensions of $F$ here are $n - r \times n - r$. So either we can have rank $1$ with  $-F = 2$ or rank $2$ with $-F = \begin{bmatrix} -2 & x \\ y & z \end{bmatrix}$

in the first case we have an RREF that is of this form: 
