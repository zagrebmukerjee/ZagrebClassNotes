...
- [[#Gauss-Jordan Redux|Gauss-Jordan Redux]]
...
Our estimate of the covariance matrix, since we don't know $\sigma$, comes from $\hat\sigma^2$, the unbiased estimator, which is:
